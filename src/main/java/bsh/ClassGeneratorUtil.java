...
//	System.out.println("constructor return type: "+constructor.getReturnType() );
    ...
    /**
     * Attempt to load a script named for the class: e.g. Foo.class Foo.bsh. The
     * script is expected to (at minimum) initialize the class body. That is, it
     * should contain the scripted class definition.
     *
     * This method relies on the fact that the ClassGenerator generateClass()
     * method will detect that the generated class already exists and initialize
